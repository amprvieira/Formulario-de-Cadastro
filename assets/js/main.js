class ValidaFormulario {
    ...
    senhasValidas(){
        ...
        if (senha.value !== repetirSenha.value){
            valid = false;
            this.createError(senha, 'Campos senha e reptir senha precisam ser iguais.')
            this.createError(repetirSenha, 'Campos senha e reptir senha precisam ser iguais.')
        }
    ...
    validaUsuario(campo){
        ...
        if (!usuario.match(/^[a-zA-Z0-9]+$/g)) {
            this.createError(campo , 'Nome do usuário precisa conter apenas letras e/ou números.');
            valid = false;
        }
        return true;
    }
